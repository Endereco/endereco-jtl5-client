...
4. **JTL-Shop Version Compatibility**: Ensure compatibility across supported JTL-Shop 5.x versions, starting with 5.3.* (e.g. 5.3.4, 5.4.1, 5.5.3, 5.6.3, 5.7.3, 5.8.0 and so on). We always test the latest patch.
...
- Test at valid JTL/PHP intersections (e.g. JTL 5.3 supports PHP 8.1, JTL 5.8 adds PHP 8.5)
...
5. ✅ JTL-Shop version compatibility tested (5.3.* - 5.8.*)
